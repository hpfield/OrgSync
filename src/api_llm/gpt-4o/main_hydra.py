...
def main(cfg: DictConfig):
    ...
    if stage <= 5:
        ...
        all_web_results = stage5_perform_web_search(
            ...
            num_results=cfg.num_search_results,
            output_dir=output_dir
        )

        sub_db = all_web_results.get(cfg.search_method, {})
